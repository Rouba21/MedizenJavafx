...
public class FrontEtablissment {
    ...
    private void actualise() throws SQLException {
        ...
        for (Etablissement etablissement : etablissementList) {
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/tn/esprit/projetpifinal/views/cardEtablissment.fxml"));
    ...
    void showMap(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/tn/esprit/projetpifinal/views/map.fxml"));
