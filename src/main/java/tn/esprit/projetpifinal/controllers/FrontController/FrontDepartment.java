...
public class FrontDepartment implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        for (int i=0; i< condidature.size();i++){
            ...
            fxmlLoader.setLocation(getClass().getResource("/tn/esprit/projetpifinal/views/ObjetDepartment.fxml"));
    ...
    public void refreche() throws IOException {
        Parent fxml = FXMLLoader.load(getClass().getResource("/tn/esprit/projetpifinal/views/ObjetDepartment.fxml"));
