  ...
  private Button btnOptions ;
    ...
    void Commenter(ActionEvent event) {
       if( commentaireContenu.getText().isEmpty()){
           ...
           try {
               ...
               CommentaireServiceMontaha commentaireService1=new CommentaireServiceMontaha();
    ...
    public void initialize(URL location, ResourceBundle resources) {
       ...
       List<Like> likes = likeService.getLikesForPub(pub.getId());
        ...
        try {
            ...
            CommentaireServiceMontaha commentaireService3=new CommentaireServiceMontaha();
    ...
    void onLikeContainerPressed(MouseEvent event) {
        if (!isLiked) {
            ...
            isLiked = true;
            Publication pub = PublicationItemController.getPublicationToGetLikes();
            LikeServiceMontaha likeService1= new LikeServiceMontaha();
