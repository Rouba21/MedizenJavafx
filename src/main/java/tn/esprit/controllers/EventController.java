...
public class EventController {
    ...
    void sponseur_btn(ActionEvent event) {
        // Ajoutez le traitement pour le bouton sponseur_btn ici
        // Par exemple, vous pouvez ouvrir une fenêtre pour gérer les sponsors ou effectuer une action spécifique liée aux sponsors
    }
